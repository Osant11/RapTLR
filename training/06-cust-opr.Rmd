...
They can be used with plain strings or chained with the text-generation functions from Chapter 6 (`fct_smpl_rest()`, `fct_var_text()`, `var_text_group()`, `fct_bsl_stats()`, `fct_mst_aes()`).
...
**Example 4 — Multi-operator chain**

Combine all four operators in a single assignment to produce a complete demographic paragraph, mirroring the structure used in the full TLR workflow (Chapter 8).
